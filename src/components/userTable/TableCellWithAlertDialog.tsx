...
export function TableCellWithAlertDialog({
  deletedRow,
}: TableCellWithAlertDialogProps) {
      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="w-full max-w-lg">
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              className="bg-transparent text-red-600 border-2 border-red-600 hover:bg-red-600 hover:text-white py-2 px-3 rounded-lg flex items-center"
