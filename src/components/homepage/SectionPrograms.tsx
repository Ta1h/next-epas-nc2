    ...
    <div id="programs" className="w-full">
      <div className="justify-center items-center flex h-56 bg-black text-white">
        ...
        <p className="px-10 w-3/6 font-normal">
          Step into the future of Electronic Product Assembly Servicing (EPAS)!
          We focus on efficiency and speed so you don&apos;t have to fret about
          your products&apos; assembly.
        </p>
      </div>
      <div className="bg-black text-white grid grid-cols-2 gap-x-10 gap-y-10 h-screen px-10 ">
        ...
        <div className="flex justify-center items-center ">
          <p className="px-10 w-3/6 font-normal">
            Step into the future of Electronic Product Assembly Servicing
            (EPAS)! We focus on efficiency and speed so you don&apos;t have to
            fret about your products&apos; assembly.
          </p>
        </div>
        <div className="flex justify-center items-center">
          <p className="px-10 w-3/6 font-normal">
