    ...
    <div className="px-10 pt-6">
      ...
      {selectedLesson.length > 0 ? (
        selectedLesson.map((lesson) => (
          <Link
            key={lesson.id} 
            href={`/userDashboard/assessment/post-test/lesson/${lesson.id}/${lesson.lessonNumber}/${lesson.lessonTitle}/${unitZero}/${unitNumber}/${unitTitle}`}
